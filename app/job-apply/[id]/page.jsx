    ...
    <div className="">
      <div className="p-4">
        ...
        <div className="bg-[#1F222A] rounded-lg p-4">
          <div className="border-b border-[#35383F] pb-2">
            <div className=" flex ">
              <div className="mr-3">
                <Image width={90} height={90} src={placeholder} alt="#" />
                <div>
      ...
      <div className="w-full bg-white-9 p-4">
        ...
        <p className="text-[#8F9098] text-xs flex mt-4 items-center">
          ...
          <span className="text-white"> &nbsp;&nbsp;Greece, Italy, India</span>
        </p>
      </div>
      {/* tabs */}
        ...
        <Tabs defaultActiveKey="1" tabBarStyle={{}}>
          <TabPane key={1} tab="Job Description">
            <ul className="list-disc text-white">
              ...
              <li>
                A Senior Manager in Engineering Change Management is a crucial
                role within an organization, particularly in industries such as
                manufacturing, aerospace, automotive, and technology, where
                product design and development are essential components of the
                business
              </li>
              <li>
                Here's an overview of the responsibilities, qualifications, and
                key aspects of this role:
              </li>
              <span className="text-lg font-bold">Role Overview:</span>
              <li>
                Change Control Leadership: Senior Managers in Engineering Change
                Management are responsible for leading and overseeing the
                process of making changes to products, designs, and engineering
                processes
              </li>
              <li>
                This includes managing cross-functional teams, setting
                priorities, and ensuring that changes are implemented smoothly
                and{' '}
