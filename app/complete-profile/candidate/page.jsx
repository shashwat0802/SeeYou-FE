...
import ProfileVisibility from "../../components/complete-profile/candidate/ProfileVisibility";
  ...
  return (
    <div>
      <ProgressBar
        ...
        setStep={setStep}
        totalSteps={5}
        type={step===5?"My Profile Visibility Status":"Fill the Form"}
      />
      <main className="pt-6 space-y-6">
        <header className={step>3?"hidden":""}>
