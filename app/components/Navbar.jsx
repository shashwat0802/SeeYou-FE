      ...
      >
        ...
        >
          <nav data-dev-hint="main navigation">
            ...
            <Link
              href="#"
              className="flex items-center space-x-4 mt-6 py-2 px-4 transition duration-200 hover:bg-gray-700 hover:text-white text-base"
            >
              <span className="text-xl">
                <IoBriefcaseOutline />
              </span>
            ...
            <Link
              href="#"
              className="flex items-center space-x-4 mt-6 py-2 px-4 transition duration-200 hover:bg-gray-700 hover:text-[#FF616D] text-[#FF616D] text-base"
            >
              <span className="text-xl">
                <IoIosLogOut />
              </span>
