            ...
            <main>
                ...
                {addedBenefits.map((benefit,index)=>(
                    <li key={index} className='relative'>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className=" absolute right-0 z-10 top-3.5 hover:cursor-pointer w-6 h-6 text-required" onClick={()=>deleteAdditionalBenefit(benefit)}>
